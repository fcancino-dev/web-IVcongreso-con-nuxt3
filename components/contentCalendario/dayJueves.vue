<template>
    <!-- <div class=""> -->
        <div class="flex flex-col md:flex-col lg:flex-row   xl:space-x-20 lg:space-x-8 space-y-6 md:space-y-10 lg:space-y-0 px-4">
            <div class=" space-y-10 font-[exo 2]">
                <div class=" flex space-x-3 md:space-x-9 lg:space-x-3 xl:space-x-9">
                    <div class="flex space-x-2 ml-1">
                        <h4>9:00 </h4><h4 class="">AM</h4>
                    </div>
                    <div class=" space-y-2 w-[17rem] md:w-full">
                        <div class=" space-y-1">
                            <h3>Ceremomia de Inauguración</h3>
                        ...
                        <div class="  border-b border-b-gray-400 h-[1px] pt-4 md:w-[21rem]"/>
                        <!-- <hr class="border-b border-b-gray-400 pt-4 w-[21rem]"> -->
                    </div>
                </div>
                <div class=" flex space-x-3 xl:space-x-8 md:space-x-8 lg:space-x-3">
            ...
            <div class=" space-y-10"> 
                <div class=" flex space-x-3 xl:space-x-8 md:space-x-8 lg:space-x-3">
                    ...
                    <div class=" space-y-2 w-[17rem] md:w-full">
                        ...
                        <div class=" border-b border-b-gray-400 h-[1px] pt-4 md:w-[21rem] xl:w-[21rem] lg:w-[20rem]"/>
                    </div>
                </div>
                <div class=" flex space-x-3 xl:space-x-8 md:space-x-8 lg:space-x-3">
                    <div class="">
